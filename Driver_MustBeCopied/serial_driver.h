...
__STATIC_INLINE bool drv_hw_driver_init (void) {
  ...
  NVIC_SetPriority(DMA2_Stream7_IRQn, DEBUG_DMA_IRQ_PRIORITY);
  ...
  LL_USART_SetBaudRate(USART1, RCC_GetPCLK2ClockFreq(SystemCoreClock), LL_USART_OVERSAMPLING_16, 115200);
